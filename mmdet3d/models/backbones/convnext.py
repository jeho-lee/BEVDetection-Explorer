...
"""
Updated ConvNext reproduction in mmpretrain
"""
...
class ConvNeXtBlock(BaseModule):
    ...
    def __init__(self,
        ...
        self.norm = LayerNorm2d(in_channels, eps=norm_cfg['eps'])
...
class ConvNeXt(BaseModule):
    ...
    def __init__(self,
        ...
        stem = nn.Sequential(
            ...
            # build_norm_layer() from mmcv.cnn.bricks.norm returns a tuple (name, layer)
            # build_norm_layer(norm_cfg, self.channels[0])[1],
            LayerNorm2d(self.channels[0], eps=norm_cfg['eps'])
        )
        ...
        for i in range(self.num_stages):
            ...
            if i >= 1:
                downsample_layer = nn.Sequential(
                    ...
                    LayerNorm2d(self.channels[i-1], eps=norm_cfg['eps']),
                    nn.Conv2d(
                        self.channels[i - 1],
                        channels,
                        kernel_size=2,
            ...
            if i in self.out_indices:
                ...
                norm_layer = LayerNorm2d(channels, eps=norm_cfg['eps'])
