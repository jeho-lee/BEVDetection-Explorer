...
lr_decay_steps = [16, 19] # bevdepth with epoch 24: [19, 23] # [16, 22] in bevbet
...
grid_size = [512, 512, 1] # bevdet: [1024, 1024, 40]
voxel_size = [0.2, 0.2, 8] # bevdet: [0.1, 0.1, 0.2]
